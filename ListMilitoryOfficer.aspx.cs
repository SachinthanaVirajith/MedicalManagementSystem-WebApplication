...
namespace MedicalManagementSystem
{
    ...
    public partial class ListMilitoryOfficer : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                cmd01.CommandText = "Select PatientName,SerialNumber,DateNTime from DisplayDetails where PState='Militory Officer'";
